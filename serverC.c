/*
** serverC.c -- serverC, one of the backend servers to process the data.
*/
...
int main(void)
{
	...
	if ((rv = getaddrinfo(NULL, CUDPPORT, &hints, &servinfo)) != 0) {//from Beej's Guide
	...
	if (p == NULL) {
		fprintf(stderr, "C: failed to bind socket\n");
		return 2;
	}
